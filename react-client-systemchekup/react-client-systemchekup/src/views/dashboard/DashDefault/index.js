...
import SystemCheckUp from './healthCheckup/SystemCheckUp';
import TableSpaceCheckup from './healthCheckup/TableSpaceCheckup';
    ...
    return (
        <React.Fragment>
            ...
            <Col md={6} xl={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">System CheckUp Items</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <SystemCheckUp height="450px" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Table Space CheckUp Items</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <TableSpaceCheckup height="450px" />
                        </Card.Body>
                    </Card>
                </Col>
                {/* <Col md={6} xl={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">System KPI Items</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <SystemKPILIst height="450px" />
                        </Card.Body>
                    </Card>
                </Col> */}
                {/* <Col md={6} xl={4}>
