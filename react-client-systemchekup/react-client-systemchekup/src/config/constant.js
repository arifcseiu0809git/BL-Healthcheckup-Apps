...
//export const BASE_TITLE = ' | React Health Checkup ';
export const BASE_TITLE = ' | System Health Checkup ';
// export const API_SERVER = 'http://localhost:8000/api/';
export const API_SERVER = 'https://ebapps.banglalink.net:41443/api/';
